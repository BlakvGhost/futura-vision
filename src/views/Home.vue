...
<template>
                        ...
                        <div class="container-custom">
                            <div class="fv-slide-title">
                                ...
                                <div style="width: 150px;" class="mt-4" :class="'fvSlideOn'">
                                    <router-link
                                        :to="{ name: 'post', params: { id: slid.id ?? 0, title: $url(slid.sup_title) } }"
        ...
        <div class="container-custom overflow-hidden">
            <div class="swiper swiper-partner">
                <div class="swiper-wrapper">
                    <div class="swiper-slide fv-w-25-lg fv-w-50-sm" v-for="partner in $reverse(data.partners)"
                        :key="partner">
                        <div class="fv-p-4-lg fv-p-3-sm">
                            <a href="javascript:void(0)" class="text-black-50 text-decoration-none" :class="'fvSlideOn'">
                                <h4 class="m-0">
                                    <img v-if="partner.logo" :src="$loadImage(partner.logo)" :alt="partner.name"
                                        :title="partner.name" style="width:34px; max-height:40px;">
                                    <i v-if="partner.icon" :class="`mdi ${partner.icon} align-middle`"
                                        :title="partner.name"></i>
                                    {{ partner.name }}
                                </h4>
                            </a>
                        </div>
            ...
            <div class="row row-cols-lg-2 row-cols-sm-1 fv-f-direc-col-sm">
                <div class="col col-lg-6 col-sm-12 fv-w-100-sm">
                    <div class="fv-title-normal">
                        <h3 class="text-uppercase text-fv-primary"><span class="dbslash">//</span> &nbsp;A propos de Nous
                        </h3>
                    </div>
                    <div class="fv-title-big" :class="'fvSlideOn'">
                        <h3 class="text-dark fw-bolder oswald-bold" data-fv-anim='autowrite'
                            :data-fv-data="$avoid(data.config, 'about_titre')">
                    ...
                    <div class="container-fluid fv-h-75-lg fv-h-100-sm fv-p-0-sm">
                        <div class="row w-100 h-100 fv-m-0-sm">
                            <div class="fv-img-fluid col col-6 p-2 fv-w-50-sm">
                                <img :src="$loadImage(data.config ? data.config.about_image_1 : null)"
                                    :alt="$avoid(data.config, 'about_experience')" class="shadow img-thumbnail">
                            </div>
                            <div class="fv-img-fluid col col-6 p-2 fv-w-50-sm">
                                <img :src="$loadImage(data.config ? data.config.about_image_2 : null)"
                                    :alt="$avoid(data.config, 'about_experience')" class="shadow img-thumbnail">
                            </div>
                            <div class="fv-img-fluid col col-6 p-2 fv-w-50-sm">
                                <img :src="$loadImage(data.config ? data.config.about_image_3 : null)"
                                    :alt="$avoid(data.config, 'about_experience')" class="shadow img-thumbnail">
                            </div>
                            <div class="fv-img-fluid col col-6 p-2 fv-w-50-sm">
                                <img :src="$loadImage(data.config ? data.config.about_image_4 : null)"
                                    :alt="$avoid(data.config, 'about_experience')" class="shadow img-thumbnail">
                            </div>
                        </div>
                    </div>
                    <div class="w-100 h-auto p-3">
                        <router-link :to="{ name: 'about' }" class="text-fv-secondary text-decoration-none"
                            :class="'fvSlideOn'">
        ...
        <div class="container-custom my-4 position-relative">
            <div class="text-center fv-w-50-lg fv-w-100-sm m-auto">
                <div class="fv-title-normal" :class="'fvSlideOn'">
                    <h4 class="text-uppercase text-fv-primary"><span class="dbslash">//</span> &nbsp;Pourquoi nous choisir ?
                    </h4>
                </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row fv-f-direc-col-sm">
                        ...
                        fv-hov-light col shadow bg-primary-x fv-p-3-lg fv-m-2-lg fv-my-2-sm
                         fv-mx-auto-sm position-relative fv-w-75-sm rounded-3" v-for="wu in $reverse(data.exploits)"
                            :key="wu">
                            <div class="position-absolute start-0 top-0 opacity-25 p-2">
                                <div class="fv-title-big opacity-50" :class="'fvSlideOn'">
                                    <h1 class="fw-bolder fa-3x oswald-bold" data-fv-anim='countdown'
                                        :data-fv-data='wu.value'></h1>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="fv-title-big">
                                ...
                                <div class="py-2 x-trans-div">
                                    <router-link class="text-fv-secondary text-decoration-none
                                     x-trans-link p-2 rounded-pill"
                                        :to="{ name: 'activity', params: { id: wu.id ?? 0, title: $url(wu.name) } }">
                                        <i class="mdi mdi-arrow-right-thin align-middle"></i>
                                        &nbsp;
                            ...
                            <div class="text-white h-100 w-100">
                                <div class="p-3">
                                    <div class="fv-slide-title">
                                        ...
                                        <div class="fv-slide-title-big" :class="'fvSlideOn'">
                                            <h5 class="fw-bolder oswald-bold">{{ $avoid(data.config,
                                                'titre_ns_choisir_bg_1') }}</h5>
                                        </div>
                                        <div class="fv-slide-title-normal" :class="'fvSlideOn'">
        ...
        <div class="container-custom my-5 pt-5 pb-3 position-relative">
            <div class="row row-cols-2">
                <div class="col">
                    ...
                    <div class="fv-title-big" :class="'fvSlideOn'">
                        <h3 class="text-dark fw-bolder oswald-bold" data-fv-anim='autowrite'
                            :data-fv-data="$avoid(data.config, 'titre_service')">
                        </h3>
                    </div>
                </div>
                <div class="col text-end align-self-end" :class="'fvSlideOn'" id="allService">
                    <router-link to="/nos-services" class="btn btn-custom text-white fw-bold">TOUT NOS
                        ...
                        <router-link :to="{ name: 'service', params: { id: sv.id ?? 0, title: $url(sv.name) } }"
                            ...
                            <div class="row">
                                <div class="col col-auto">
                                    <img v-if="sv.logo" :src="$loadImage(sv.logo)" :alt="sv.name" :title="sv.name"
                                        style="width:34px; max-height:40px;">
            ...
            <div class="fv-position-absolute-lg start-0 w-100 fv-h-100-sm" style="bottom: -29%;height: 150px;">
                <div class="shadow p-3 position-relative full">
                    <div class="position-absolute start-0 top-0 full rank"
                        :style="`background-image: url('${$loadImage(data.config ? data.config.image_contact_bg : null)}');`">
                    ...
                    <div class="containter-fluid full">
                        <div class="row row-cols-2 mb-4">
                            <div class="col">
                                ...
                                <div class="fv-title-big" :class="'fvSlideOn'">
                                    <h4 class="text-white fw-bolder oswald-bold" data-fv-anim='autowrite'
                                        :data-fv-data="$avoid(data.config, 'titre_contact')">
                                    </h4>
                                </div>
                            </div>
                            <div class="col text-end align-self-end" :class="'fvSlideOn'">
                                <router-link :to="{ name: 'contact' }" class="btn btn-outline-light fw-bold">Nous
        ...
        <div class="container-custom my-5 position-relative py-3 fv-text-center-sm">
            <div class="row row-cols-2 mt-4" :class="'fvSlideOn'">
                <div class="col fv-w-100-sm">
                    <div class="fv-title-normal" :class="'fvSlideOn'">
                        <h4 class="text-uppercase text-fv-primary m-auto"><span class="dbslash">//</span> &nbsp; derniers
                            projets realisés </h4>
                    </div>
                    <div class="fv-title-big" :class="'fvSlideOn'">
                        <h4 class="text-dark fw-bolder oswald-bold" data-fv-anim='autowrite'
                            :data-fv-data="$avoid(data.config, 'titre_projet')"></h4>
                    </div>
                </div>
                        ...
                        <div class="swiper-slide fv-w-25-lg fv-w-100-sm h-100 fv-mx-3-lg
                            ...
                            <div class="position-absolute start-0 w-100" :class="'fvSlideOn'" style="bottom: -15%;">
                                <div class="shadow position-relative h-100 w-75 m-auto header-color
                                     overflow-hidden fv-hov-light"
                                    style="border-top-left-radius: 30%; border-bottom-right-radius: 30%">
                                    <div class="p-3">
                                        <div class="fv-title-big">
    ...
    <div id="i" class="bg-white w-100 text-white">
        <div class="container-custom py-4 overflow-hidden position-relative">
            ...
            <div class="carousel-control">
                <a href="javascript:void(0)" class="text-dark text-decoration-none position-absolute start-0 y-prev fv-zd"
                    style="top: 60%;">
                    <i class="mdi mdi-arrow-left-thin mdi-24px"></i>
                </a>
                <a href="javascript:void(0)" class="text-dark text-decoration-none position-absolute end-0 y-next fv-zd"
                    style="top: 60%;">
        ...
        <div class="container-custom fv-py-4-lg overflow-hidden position-relative">
                    ...
                    <div class="swiper-slide full" v-for="tm in $reverse(data.teams)" :key="tm.id">
                        <div class="col p-3 text-center">
                            ...
                            <div class="text-center text-dark">
                                <div class="my-2">
                                    <img :src="$loadImage(tm.avatar)" style="width:82px;height:82px"
            ...
            <div class="carousel-control">
                <a href="javascript:void(0)"
                    class="text-dark text-decoration-none position-absolute start-0 team-prev fv-zd" style="top: 60%;">
                    <i class="mdi mdi-arrow-left-thin mdi-24px"></i>
                </a>
                <a href="javascript:void(0)" class="text-dark text-decoration-none position-absolute end-0 team-next fv-zd"
                    style="top: 60%;">
                    <i class="mdi mdi-arrow-right-thin mdi-24px"></i>
                </a>
            </div>
    ...
    <div id="f" class="fv-p-0-sm">
        <div class="container-custom my-5 position-relative">
            ...
            <div class="row row-cols-3 my-3 fv-f-direc-col-sm">
                <Blog v-for="post in blogs" :key="post.id" :post="post" style-custom="height:290px;"
                    bg-style-custom="height:100px;" :user="user">
                </Blog>
            </div>
        </div>
    </div>
    <div id="j">
        <div class="container-custom mt-5 pb-3 position-relative">
            ...
            <div class="row row-cols-3 my-3 fv-f-direc-col-sm">
                <Forum v-for="post in forums" :key="post.id" :post="post" :user="user">
                </Forum>
            </div>
        </div>
    </div>
